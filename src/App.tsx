...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans selection:bg-emerald-100 selection:text-blue-900">
      {/* Navigation */}
      <nav className="bg-white/80 backdrop-blur-md border-b border-slate-200 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-20 items-center">
            ...
            >
              <img src="/assets/logo.png" className="h-14 w-auto mr-3 object-contain" alt="SUB'ECOIMPACT" />
              <div className="flex flex-col text-left">
                <span className="text-xl font-black text-slate-900 tracking-tighter uppercase leading-none">SUB'ÉCO IMPACT</span>
                <span className="text-[10px] font-bold text-green-600 tracking-widest uppercase mt-1">Activer les aides, créer l’impact</span>
              </div>
            </div>
            ...
            <div className="hidden md:flex space-x-10 items-center">
              <button 
                onClick={() => setView('landing')} 
                className={`text-sm font-bold tracking-tight transition-colors ${view === 'landing' ? 'text-emerald-600' : 'text-slate-500 hover:text-slate-900'}`}
              >
                Accueil
              </button>
              ...
              {user ? (
                ...
                <>
                  <a href="#features" className="text-sm font-bold text-slate-600 hover:text-emerald-600 transition-colors">Solutions</a>
                  <button 
                    onClick={() => setView('login')} 
                    className="bg-slate-900 text-white px-7 py-3 rounded-xl text-sm font-bold hover:bg-emerald-600 transition-all shadow-xl shadow-slate-200 flex items-center"
                  >
      ...
      <footer className="bg-slate-950 text-slate-400 py-20 px-4">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="col-span-1 md:col-span-2 text-left">
            <div className="flex items-center mb-6">
               <img src="/assets/logo.png" className="h-12 w-auto mr-3 object-contain rounded-lg" alt="SUB'ECOIMPACT" />
               <span className="text-white font-black text-2xl tracking-tighter uppercase">SUB'ÉCO IMPACT</span>
            </div>
            ...
            <div className="flex space-x-4 mt-8">
              <a href="#" className="w-10 h-10 rounded-lg bg-slate-900 flex items-center justify-center hover:bg-emerald-600 transition-colors text-white">
          ...
          <div className="text-left">
            ...
            <ul className="space-y-4 text-sm">
              <li><a href="#" className="hover:text-emerald-400 transition-colors">Veille Territoriale</a></li>
              <li><a href="#" className="hover:text-emerald-400 transition-colors">Générateur IA</a></li>
              <li><a href="#" className="hover:text-emerald-400 transition-colors">Tarification</a></li>
            </ul>
          </div>
          <div className="text-left">
            <h4 className="text-white font-bold mb-6 text-sm uppercase tracking-widest">Support</h4>
            <ul className="space-y-4 text-sm">
              <li><a href="#" className="hover:text-emerald-400 transition-colors">Guide Utilisateur</a></li>
        ...
        <div className="max-w-7xl mx-auto mt-20 pt-10 border-t border-slate-900 flex flex-col md:flex-row justify-between items-center text-[10px] font-bold uppercase tracking-widest text-slate-600">
          <div>© {new Date().getFullYear()} SUB'ÉCO IMPACT. Réalisé par Concept-AI-972.</div>
